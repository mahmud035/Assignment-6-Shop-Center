  ...
  return (
    <div>
      ...
      <h2 className="mt-2 text-sm lg:text-base">
        <Link
          href={`/products/${id}`}
          className="text-base font-bold hover:border-b hover:border-black"
        >
          {title}{' '}
        </Link>
        <span className="text-[#919090] capitalize hover:border-b hover:border-[#919090]">
          <Link href={`/category/${category}`}>({category})</Link>
        </span>
      </h2>
      <p className="text-[#919090] text-sm mt-1">
